    ...
    <div className="min-h-screen bg-moroccan-cream/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center space-x-2 mb-8">
          <Link href="/products" className="flex items-center text-moroccan-navy hover:text-moroccan-terracotta transition-colors">
            ...
            {(product.images || []).length > 1 && (
              <div className="flex space-x-2">
                {(product.images || []).map((image: string, index: number) => (
                  ...
                  >
                    <Image src={image || "/placeholder.svg"} alt={`${getProductName(product)} ${index + 1}`} fill className="object-cover" />
                  </button>
                ))}
              </div>
            )}
            ...
            <div className="space-y-4">
              <div className="flex space-x-4">
                ...
                >
                  ...
                  {(product.stock || 0) === 0 ? t("outOfStock") : t("addToCart")}
                </Button>
                <Button
                  variant="outline"
                  size="lg"
